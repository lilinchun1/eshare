$(function(){	
	...
	$("input[name=agent_id]").val(GetQueryString('agent_id'));
    ...
    if($("input[name=gc_id]").val()!=''){
    	...
    	$.ajax({
    		url:ApiUrl+"/index.php?act=goods&op=goods_list&key=4&page="+pagesize+"&curpage=1"+'&gc_id='+$("input[name=gc_id]").val()+'&agent_id='+$("input[name=agent_id]").val(),
    		type:'get',
    		dataType:'json',
    	...
    	$.ajax({
    		url:ApiUrl+"/index.php?act=goods&op=goods_list&key=4&page="+pagesize+"&curpage=1"+'&agent_id='+$("input[name=agent_id]").val(),
    		type:'get',
    		dataType:'json',
    		success:function(result){
    			$("input[name=hasmore]").val(result.hasmore);
    ...
    $("select[name=page_list]").change(function(){
    	...
    	if(gc_id>0){
    		var url = ApiUrl+"/index.php?act=goods&op=goods_list&key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&gc_id="+gc_id+'&agent_id='+$("input[name=agent_id]").val();
    	}else{
    		var url = ApiUrl+"/index.php?act=goods&op=goods_list&key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&keyword="+keyword+'&agent_id='+$("input[name=agent_id]").val();
    	}
	...
	$('.keyorder').click(function(){
		...
		if(gc_id>0){
			var url = ApiUrl+"/index.php?act=goods&op=goods_list&key="+curkey+"&order="+curorder+"&page="+page+"&curpage=1&gc_id="+gc_id+'&agent_id='+$("input[name=agent_id]").val();
		}else{
			var url = ApiUrl+"/index.php?act=goods&op=goods_list&key="+curkey+"&order="+curorder+"&page="+page+"&curpage=1&keyword="+keyword+'&agent_id='+$("input[name=agent_id]").val();
		}

...
<div class="ncsc-form-default" nctype="normal" >
  <form method="post" action="index.php?act=weixin_subscribe&op=subscribe_save" id="normal_form" enctype="multipart/form-data">
    ...
    <dl>
      ...
      <dd>
        <div class="ncsc-upload-thumb store-sns-pic">
          <p><img nc_type="logo1" src="<?php echo wxShareImage($output['subscribe_info']['pic_url'],$_SESSION['store_id']);?>"/></p>
        </div>
        <div class="handle">

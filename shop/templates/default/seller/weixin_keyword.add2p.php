<div class="eject_con">
   <form method="post" action="index.php?act=weixin_keyword&op=keyword_saveas&keyword_id=<?php echo $_GET['keyword_id']?>" id="recommend_form" enctype="multipart/form-data">
    ...
    <dl>
      ...
      <dd>
        <p>
          <input type="text" class="text w400" name="keyword" value="<?php echo empty($output['keyword_info']['title'])?'':$output['keyword_info']['title']?>" placeholder="" />
        </p>
      </dd>
    </dl>
    <dl>

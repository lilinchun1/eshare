  ...
  <div class="top-container">
    <div class="basic-info">
      <dl class="ncsc-seller-info">
        ...
        <?php if($_SESSION['seller_is_admin']==1){?>
       ...
       <?php }else {?>
       <dd class="store-logo"><p><img src="<?php echo getStoreLogo($output['store_info']['store_label']);?>"/></p></dd>
       <?php }?>
        ...
        <dd class="store-validity"><?php echo $lang['store_validity'].$lang['nc_colon'];?><strong><?php echo $output['store_info']['store_end_time_text'];?></strong></dd>
     	<?php }else{?>
     	 ...
     	 <dd class="store-grade"></dd>
     	  <dd class="store-validity"></dd>
     	<?php }?>
      </dl>
      ...
      <div class="content">
        <ul>
          ...
          <li><a target="_blank" href="<?php if(!empty($val['article_url']))echo $val['article_url'];else{ echo urlShop('article', 'show',array('article_id'=>$val['article_id']));}?>" title="<?php echo $val['article_title']; ?>"><?php echo str_cut($val['article_title'],24);?></a></li>
     		<?php }else{?>
 				 <li><a href=""><?php echo str_cut($val['article_title'],24);?></a></li>
     		<?php }?>
			<?php
				}
			}
        ...
        <table class="ncsc-table-style">
          ...
          <tbody>
            ...
            <tr class="bd-line">
              ...
              <?php }else{?>
              <td><div class="pic-thumb"><img alt="<?php echo $val['goods_name'];?>" src="<?php echo thumb($val, '60');?>"></div></td>
              <td><dl class="goods-name">
               <dt><a href =""><?php echo $val['goods_name'];?></a></dt>
                </dl></td>
              <?php }?>

...
<form method="get" action="index.php" target="_self">
  ...
  <table class="search-form">
    ...
    <tr>
      ...
      <th>代理商ID</th>
      <td class="w80"><input type="text" class="text w70" name="agent_id" value="<?php echo $_GET['agent_id']; ?>" /></td>
...
<table class="ncsc-table-style order">
  <thead>
    <tr>
      ...
      <th class="w110"><?php echo $lang['store_show_order_isorder'];?></th>
  ...
  <tbody>
    ...
    <tr>
      <th colspan="20">
        <span class="fl ml10"><?php echo $lang['store_order_order_sn'].$lang['nc_colon'];?>
      		<span class="goods-num"><em><?php echo $order['order_sn']; ?></em><?php if ($order['order_from'] == 2){?><i class="icon-mobile-phone"></i><?php }?></span>
        </span>
        <span class="fl ml20"><?php echo $lang['store_order_add_time'].$lang['nc_colon'];?><em class="goods-time"><?php echo date("Y-m-d H:i:s",$order['add_time']); ?></em></span>
        <span class="fl ml20">代理商ID<?php echo $lang['nc_colon'];?><a href="#<?php echo $order['agent_id'];?>"> <?php echo $order['extend_agent_member']['member_truename'];?></a></span>
        <span class="fr mr5">
<?php if ($order['if_deliver']) { ?>
        ...
        <a href="index.php?act=store_order_print&order_id=<?php echo $order_id;?>" class="ncsc-btn-mini <?php echo $order['point_num']>0?'btn-active':'';?>" target="_blank" title="打印发货单"/><i class="icon-print"></i>打印发货单</a></span>
    ...
    <tr>
      ...
      <?php if ($order['extend_order_common']['invoice_info']){; ?>
      <td >
      ...
      <td class="bdl" rowspan="<?php echo count($order['extend_order_goods']);?>">
        <div class="buyer"><?php echo $order['extend_order_common']['reciver_name'];?>

...
<div><a href="javascript:void(0)" class="ncsc-btn ncsc-btn-green" nc_type="dialog" dialog_title="增加图文" dialog_id="my_goods" dialog_width="720" uri="index.php?act=weixin_keyword&op=keyword_addpic">增加图文</a></div>
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle">
       <span><a href="javascript:void(0)" class="btn-blue" nc_type="dialog" dialog_title="编辑回复" dialog_id="my_goods_brand_edit" dialog_width="720" uri="index.php?act=weixin_keyword&op=keyword_editpic&reply_id=<?php echo $val['reply_id']; ?>"><i class="icon-edit"></i><p><?php echo $lang['nc_edit'];?></p></a></span>
       <span><a href="javascript:void(0)" class="btn-red" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', 'index.php?act=weixin_keyword&op=keyword_delas&reply_id=<?php echo $val['reply_id']; ?>&keyword_id=<?php echo $val['keyword_id'];?>');"><i class="icon-trash"></i><p><?php echo $lang['nc_del'];?></p></a></span></td>
    </tr>
    <?php } ?>
    <?php } else { ?>
    <tr>

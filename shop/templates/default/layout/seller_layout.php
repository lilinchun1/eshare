...
<header class="ncsc-head-layout w">
  <div class="wrapper">
    <div class="ncsc-admin">
      ...
      <?php }else{?>
      <div class="ncsc-admin-function"><a href="<?php echo urlShop('home', 'passwd');?>" title="修改密码" target="_blank"><i class="icon-wrench"></i></a><a href="<?php echo urlShop('seller_logout', 'logout');;?>" title="安全退出"><i class="icon-signout"></i></a></div>
      <?php }?>
    </div>

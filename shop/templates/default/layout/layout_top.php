...
<div class="public-top-layout w">
  <div class="topbar wrapper">  
    ...
    <?php }else{?>
     <?php echo $lang['nc_hello'];?><span><a href=""><?php echo $_SESSION['member_name'];?></a></span><?php echo $lang['nc_comma'],$lang['welcome_to_site'];?>
      <a href="">  <span><?php echo $GLOBALS['setting_config']['site_name']; ?></span></a>
      <span>[<a href="<?php echo urlShop('login','logout');?>"><?php echo $lang['nc_logout'];?></a>]</span>
    <?php }?>
      <?php }else{?>

    ...
    private function _getMenuList() {
        $menu_list = array(
            ...
            'store' => array('name' => '店铺', 'child' => array(
               ...
               array('name' => '店铺帮助', 'act'=>'store_article', 'op'=>'article_list'),
                array('name' => '微信分享', 'act'=>'store_share', 'op'=>'share_list'),
            )),
            ...
            'account' => array('name' => '帐号', 'child' => array(
                ...
                array('name' => '微信配置', 'act'=>'access_token', 'op'=>'index'),
			    array('name' => '自动回复', 'act'=>'weixin_auto', 'op'=>'index'),
			    array('name' => '关注回复', 'act'=>'weixin_subscribe', 'op'=>'index'),
                array('name' => '关键字回复', 'act'=>'weixin_keyword', 'op'=>'index'), 
            ))
        );
        return $menu_list;
    }

...
class memberModel extends Model {
	...
	public function addMember($param) {
		...
		$member_info['member_truename']		= $param['member_name'];//zhangyating 2014-9-16
	...
	private function getCondition($conditon_array){
		...
		if($conditon_array['is_agent'] != '') {
			$is_agent = $conditon_array['is_agent'] ? 1 : 0;
			$condition_sql	.= " and is_agent = {$is_agent}";
		}
...
// 	}
	...
	public function getMemberByMobile($mobile){
		...
		return $this->where(array('member_mobile'=>$mobile))->find();
	}
}

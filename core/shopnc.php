 ...
 * 运行框架
 *
 * @copyright  Copyright (c) 2007-2013 ShopNC Inc. (http://www.esharecn.cn)
 * @license    http://www.esharecn.cn
 * @author	   EShare Tech Team
...
/* CDN URL */
define('IMG_CDN_URL',$config['img_cdn_url']);
define('JS_CDN_URL',$config['js_cdn_url']);
